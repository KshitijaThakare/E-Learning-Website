...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		<div class="col-md-3 text-success">
			<h3>
				<i class="fa-solid fa-book"></i> E-Courses
			</h3>
		</div>
		<div class="col-md-6">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a class="nav-link" href="#"> <i class="fa-solid fa-book-open"></i> Recent Courses</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="#"> <i class="fa-solid fa-book-open"></i> New Course</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link disabled" href="#"> <i class="fa-solid fa-book-open"></i> Courses</a>
      </li>
    </ul>
    <form class="form-inline my-2 my-lg-0">
